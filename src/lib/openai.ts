 ...
 */
export async function generateWeeklyReport(emotionCheckins: any[]) {
  try {
    ...
    Por favor, analise os seguintes dados de check-ins emocionais do usuário nos últimos 7 dias e gere um relatório semanal informativo e útil.
