        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <div className="flex-shrink-0 flex items-center">
              <EquilibriLogo className="h-auto" imageSize="md" />
            </div>
          ...
          <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
            <div className="text-center">
              <div className="flex justify-center mb-12">
                <EquilibriLogo className="h-auto" imageSize="xl" />
              </div>
              ...
              <div className="mt-10 flex justify-center gap-4">
                <Link href="/register" passHref legacyBehavior>
                  <PremiumButton variant="metallic" size="lg">
                    Começar agora
                  </PremiumButton>
                </Link>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:flex lg:items-center lg:justify-between">
              ...
              <div className="lg:w-5/12">
                <PremiumCard variant="glass" className="p-6 max-w-md mx-auto lg:mx-0">
                  ...
                  <div className="space-y-3">
                    ...
                    <PremiumCard variant="metallic" className="p-4 ml-auto mr-4 max-w-[80%]">
                      <p className="text-text-primary text-sm">
                  ...
                  <div className="mt-4 flex">
                    ...
                    <PremiumButton variant="ghost" className="ml-2">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16">
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-2">
                {/* Feature Cards */}
                <PremiumCard variant="glass" className="p-6 hover:transform hover:-translate-y-1 transition-all duration-300">
