...
var premium_button_1 = require("@/components/ui/premium-button");
var premium_card_1 = require("@/components/ui/premium-card");
var whatsapp_button_1 = require("@/components/ui/whatsapp-button");
function HomePage() {
    return (<div className="flex flex-col min-h-screen bg-background">
      <whatsapp_button_1.WhatsAppButton>{null}</whatsapp_button_1.WhatsAppButton>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <div className="flex-shrink-0 flex items-center">
              <logo_1.EquilibriLogo className="h-auto" imageSize="md">{null}</logo_1.EquilibriLogo>
            </div>
            <div className="hidden md:ml-6 md:flex md:space-x-8">
              <link_1.default href="#features" className="inline-flex items-center px-1 pt-1 text-sm font-medium text-foreground hover:text-primary transition-colors">
                Funcionalidades
              </link_1.default>
              <link_1.default href="#how-it-works" className="inline-flex items-center px-1 pt-1 text-sm font-medium text-foreground hover:text-primary transition-colors">
                Como Funciona
              </link_1.default>
              <link_1.default href="#pricing" className="inline-flex items-center px-1 pt-1 text-sm font-medium text-foreground hover:text-primary transition-colors">
                Planos
              </link_1.default>
            </div>
            <div className="flex items-center gap-4">
              <link_1.default href="/login" passHref legacyBehavior>
                <premium_button_1.PremiumButton variant="ghost" size="sm">Entrar{null}</premium_button_1.PremiumButton>
              </link_1.default>
              <link_1.default href="/register" passHref legacyBehavior>
                <premium_button_1.PremiumButton variant="default" size="sm">Começar Grátis{null}</premium_button_1.PremiumButton>
              </link_1.default>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
            <div className="text-center">
              <div className="flex justify-center mb-12">
                <logo_1.EquilibriLogo className="h-auto" imageSize="xl">{null}</logo_1.EquilibriLogo>
              </div>
              ...
              <div className="mt-10 flex justify-center gap-4">
                <link_1.default href="/register" passHref legacyBehavior>
                  <premium_button_1.PremiumButton variant="metallic" size="lg">Começar agora{null}</premium_button_1.PremiumButton>
                </link_1.default>
                <link_1.default href="/login?redirect=chat" passHref legacyBehavior>
                  <premium_button_1.PremiumButton variant="glass" size="lg">Converse com Lari{null}</premium_button_1.PremiumButton>
                </link_1.default>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:flex lg:items-center lg:justify-between">
              <div className="lg:w-1/2 mb-10 lg:mb-0">
                ...
                <div className="mt-8">
                  <link_1.default href="/login?redirect=chat" passHref legacyBehavior>
                    <premium_button_1.PremiumButton variant="metallic" size="lg">
                      Conversar com Lari
                    ...
                    </premium_button_1.PremiumButton>
                  </link_1.default>
                </div>
              </div>
              <div className="lg:w-5/12">
                <premium_card_1.PremiumCard variant="glass" className="p-6 max-w-md mx-auto lg:mx-0">{null}</premium_card_1.PremiumCard>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16">
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-2">
                {/* Feature Cards */}
                <premium_card_1.PremiumCard variant="glass" className="p-6 hover:transform hover:-translate-y-1 transition-all duration-300">{null}</premium_card_1.PremiumCard>
        ...
        <div className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 text-center">
              <link_1.default href="/register" className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-white bg-primary hover:bg-primary-light transition-colors">
            ...
            <div className="mt-16 grid grid-cols-1 gap-6 lg:grid-cols-3">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-border overflow-hidden">
                <div className="px-6 py-8">
                  ...
                  <premium_button_1.PremiumButton className="mt-8 w-full" variant="outline">
                    Começar Grátis
                  </premium_button_1.PremiumButton>
                </div>
              ...
              <div className="bg-white rounded-lg shadow-lg border-2 border-primary overflow-hidden relative">
                ...
                <div className="px-6 py-8">
                  ...
                  <premium_button_1.PremiumButton className="mt-8 w-full" variant="default">
              ...
              <div className="bg-white rounded-lg shadow-lg border-2 border-brand overflow-hidden relative">
                ...
                <div className="px-6 py-8">
                  ...
                  <premium_button_1.PremiumButton className="mt-8 w-full bg-brand hover:bg-brand/90">
        ...
        <div className="bg-primary">
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
            ...
            <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0 gap-4">
              <link_1.default href="/register" className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-primary bg-accent hover:opacity-90 transition-colors">
                Começar Grátis
              </link_1.default>
              <link_1.default href="#how-it-works" className="inline-flex items-center justify-center px-5 py-3 border border-accent text-base font-medium rounded-md text-accent bg-transparent hover:bg-primary-light transition-colors">
                Saiba mais
              </link_1.default>
            </div>
          </div>
      ...
      <footer className="bg-background-secondary border-t border-border">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <div>
              <logo_1.EquilibriLogo className="h-auto" imageSize="sm" showText={false}>{null}</logo_1.EquilibriLogo>
